                ...
                <div className="rounded-2xl border border-border bg-card/70 p-6">
                    <div className="flex flex-wrap items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground mt-1">Full control over mode, color, typography, contrast, and shape.</p>
                        </div>
                            ...
                            <CardContent className="space-y-5">
                                <div className="space-y-2">
                                    ...
                                    <Select value={data.mode} onValueChange={(value: AppearanceMode) => setData('mode', value)}>
                                        <SelectTrigger id="appearance-mode" className="w-full"><SelectValue /></SelectTrigger>
                                        <SelectContent>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select value={data.color} onValueChange={(value: AppearanceColor) => setData('color', value)}>
                                        <SelectTrigger id="appearance-color" className="w-full"><SelectValue /></SelectTrigger>
                                        <SelectContent>
                                            {COLOR_OPTIONS.map((option) => (
                                                <SelectItem key={option.value} value={option.value}>
                                                    <span className="flex items-center gap-2">
                                                        <span className="size-2.5 rounded-full" style={{ backgroundColor: option.swatch }} />
                                                        {option.label}
                                                    </span>
                                                </SelectItem>
                                            ))}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select value={data.font} onValueChange={(value: AppearanceFont) => setData('font', value)}>
                                        <SelectTrigger id="appearance-font" className="w-full"><SelectValue /></SelectTrigger>
                                        <SelectContent>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="space-y-2">
                                        ...
                                        <Select value={data.radius} onValueChange={(value: AppearanceRadius) => setData('radius', value)}>
                                            <SelectTrigger id="appearance-radius" className="w-full"><SelectValue /></SelectTrigger>
                                            <SelectContent>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select value={data.contrast} onValueChange={(value: AppearanceContrast) => setData('contrast', value)}>
                                            <SelectTrigger id="appearance-contrast" className="w-full"><SelectValue /></SelectTrigger>
                                            <SelectContent>
                                    ...
                                    <div className="grid grid-cols-2 gap-2">
                                        {PRESETS.map((preset) => (
                                            ...
                                            >
                                                ...
                                                {preset.isDefault && (
                                                    <span className="text-[10px] font-semibold uppercase tracking-wide opacity-60">Default</span>
                                                )}
                                            </button>
                                        ))}
                                    </div>
                            ...
                            <CardContent>
                                <div className="grid gap-4 lg:grid-cols-[260px_minmax(0,1fr)]">
                                    <div className="rounded-xl border border-border bg-sidebar text-sidebar-foreground p-3 space-y-3">
                                        <div className="rounded-md bg-sidebar-accent text-sidebar-accent-foreground px-3 py-2 text-sm font-medium">Inbox</div>
                                    ...
                                    <div className="space-y-4">
                                        <div className="grid gap-4 md:grid-cols-2">
                                            <div className="rounded-xl border border-border bg-card p-4 space-y-3">
                                                ...
                                                <div className="flex gap-2">
                                                    <span className="inline-flex rounded-md bg-primary px-3 py-1.5 text-xs text-primary-foreground">Send</span>
                                                    <span className="inline-flex rounded-md bg-secondary px-3 py-1.5 text-xs text-secondary-foreground">Draft</span>
                                                </div>
                                            </div>
                                        ...
                                        <div className="rounded-xl border border-border bg-background p-4">
                                            ...
                                            <div className="mt-3 space-y-2">
                                                <div className="max-w-[75%] rounded-lg border border-border bg-muted/40 px-3 py-2 text-sm">Hi team, can you help with my invoice?</div>
                                                <div className="ml-auto max-w-[75%] rounded-lg bg-primary px-3 py-2 text-sm text-primary-foreground">Absolutely. I am checking it now.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>

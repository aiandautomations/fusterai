...
interface Guidance { spf: string; dkim: string; dmarc: string }
    ...
    <AppLayout title="Email Deliverability">
      <div className="w-full px-6 py-8 space-y-8">
        ...
        <div className="space-y-2">
          ...
          {mailboxes.length === 0 ? (
            <p className="text-sm text-muted-foreground">No mailboxes configured yet. <a href="/mailboxes/create" className="text-primary underline">Create one</a>.</p>
          ) : (
            <div className="space-y-2">
              {mailboxes.map(m => (
        ...
        <div className="space-y-4">
          <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground">Recommended DNS Records</h2>
            ...
            <div className="border rounded-md p-4 space-y-2">
              ...
              <p className="text-xs text-muted-foreground">Add a TXT record at <code>_dmarc.yourdomain.com</code>:</p>

...
interface SlaData {
    ...
    first_response_status: 'achieved' | 'breached' | 'pending';
    resolution_status: 'achieved' | 'breached' | 'pending';
...
interface Props {
    conversation: Conversation & { sla?: SlaData };
}

function StatusBadge({ status }: { status: SlaData['first_response_status'] }) {
    const config = {
...
export default function SlaSidebarPanel({ conversation }: Props) {
